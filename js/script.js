...
const config = {
    serverInfo: {
        ...
        serverName: "SPYMC.XYZ", /*Server name*/
        serverIp: "SPYMC.XYZ", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "921023003981144125" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
